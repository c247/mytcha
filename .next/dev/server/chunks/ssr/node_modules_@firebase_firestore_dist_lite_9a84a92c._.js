module.exports = [
"[project]/node_modules/@firebase/firestore/dist/lite/common-df61403f.node.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const logClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"]('@firebase/firestore');
/**
...
function logDebug(msg, ...obj) {
    if (logClient.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LogLevel"].DEBUG) {
...
/** Credential provider for the Lite SDK. */ class LiteAuthCredentialsProvider {
    ...
    getToken() {
        ...
        return this.auth.getToken().then((tokenData)=>{
            if (tokenData) {
                hardAssert(typeof tokenData.accessToken === 'string', 0xa539, {
                    tokenData
                });
...
/** AppCheck token provider for the Lite SDK. */ class LiteAppCheckTokenProvider {
    ...
    getToken() {
        ...
        return this.appCheck.getToken().then((tokenResult)=>{
            if (tokenResult) {
                hardAssert(typeof tokenResult.token === 'string', 0x0d8e, {
                    tokenResult
                });
 ...
 */ class RestConnection {
    ...
    invokeRPC(rpcName, path, req, authToken, appCheckToken) {
        ...
        const forwardCredentials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isCloudWorkstation"])(host);
 ...
 */ function validateJSON(json, schema) {
    ...
    for(const key in schema){
        if (schema[key]) {
            ...
            const value = 'value' in schema[key] ? {
...
class FieldFilter extends Filter {
    ...
    matches(doc) {
        ...
        if (this.op === "!=" /* Operator.NOT_EQUAL */ ) {
            return other !== null && other.nullValue === undefined && this.matchesComparison(valueCompare(other, this.value));
        }
...
function fromResourceName(name) {
    ...
    hardAssert(isValidResourceName(resource), 0x27ce, {
...
function extractLocalPathFromResourceName(resourceName) {
    hardAssert(resourceName.length > 4 && resourceName.get(4) === 'documents', 0x71a3, {
...
function fromPipelineResponse(serializer, proto, document) {
    ...
    const executionTime = proto.executionTime ? fromVersion(proto.executionTime) : undefined;
    output.executionTime = executionTime;
    if (!!document) {
        output.key = document.name ? fromName(serializer, document.name) : undefined;
        output.fields = new ObjectValue({
            mapValue: {
                fields: document.fields
            }
        });
        output.createTime = document.createTime ? fromVersion(document.createTime) : undefined;
        output.updateTime = document.updateTime ? fromVersion(document.updateTime) : undefined;
    }
    return output;
}
...
function isProtoValueSerializable(// eslint-disable-next-line @typescript-eslint/no-explicit-any
value) {
...
function initializeFirestore(app, settings, databaseId) {
    ...
    const provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(app, 'firestore/lite');
...
function getFirestore(appOrDatabaseId, optionalDatabaseId) {
    const app = typeof appOrDatabaseId === 'object' ? appOrDatabaseId : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])();
    const databaseId = typeof appOrDatabaseId === 'string' ? appOrDatabaseId : optionalDatabaseId || '(default)';
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(app, 'firestore/lite').getImmediate({
 ...
 */ function connectFirestoreEmulator(firestore, host, port, options = {}) {
    ...
    if (useSsl) {
        void (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pingServer"])(`https://${newHostSetting}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateEmulatorBanner"])('Firestore', true);
    }
    ...
    if (options.mockUserToken) {
        ...
        if (typeof options.mockUserToken === 'string') {
            ...
            token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createMockUserToken"])(options.mockUserToken, firestore._app?.options.projectId);
 ...
 */ function terminate(firestore) {
    firestore = cast(firestore, Firestore);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_removeServiceInstance"])(firestore.app, 'firestore/lite');
...
/** Parse update data from a list of field/value arguments. */ function parseUpdateVarargs(userDataReader, methodName, targetDoc, field, value, moreFieldsAndValues) {
    const context = userDataReader.createContext(1 /* UserDataSource.Update */ , methodName, targetDoc);
    const keys = [
        fieldPathFromArgument(methodName, field, targetDoc)
    ];
    const values = [
        value
    ];
 ...
 */ class AbstractUserDataWriter {
    ...
    convertDocumentKey(name, expectedDatabaseId) {
        ...
        hardAssert(isValidResourceName(resourcePath), 0x25d8, {
            name
        });
...
"[project]/node_modules/@firebase/firestore/dist/lite/index.node.mjs [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
 ...
 */ class ExponentialBackoff {
     ...
     */ backoffAndRun(op) {
        ...
        if (remainingDelayMs > 0) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(LOG_TAG$1, `Backing off for ${remainingDelayMs} ms ` + `(base delay: ${this.currentBaseMs} ms, ` + `delay with jitter: ${desiredDelayWithJitterMs} ms, ` + `last attempt: ${delaySoFarMs} ms ago)`);
        }
 ...
 */ function registerFirestore() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["registerVersion"])('firestore-lite', version, 'node');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["registerVersion"])('firestore-lite', version, 'esm2020');
}
/**
 * @license
 * Copyright 2023 Google LLC
 ...
 */ class AggregateQuerySnapshot {
     ...
     */ _fieldsProto() {
        ...
        const dataClone = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["O"]({
            mapValue: {
                fields: this._data
            }
        }).clone();
 ...
 */ function getAggregate(query, aggregateSpec) {
    const firestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(query.firestore, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["F"]);
    const datastore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"])(firestore);
    const internalAggregates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["m"])(aggregateSpec, (aggregate, alias)=>{
        return new AggregateImpl(alias, aggregate.aggregateType, aggregate._internalFieldPath);
    });
    // Run the aggregation and convert the results
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["i"])(datastore, query._query, internalAggregates).then((aggregateResult)=>convertToAggregateQuerySnapshot(firestore, query, aggregateResult));
}
function convertToAggregateQuerySnapshot(firestore, query, aggregateResult) {
    const userDataWriter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"](firestore);
 ...
 */ function sum(field) {
    return new AggregateField('sum', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["f"])('sum', field));
}
/**
 ...
 */ function average(field) {
    return new AggregateField('avg', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["f"])('average', field));
}
/**
 ...
 */ function aggregateQuerySnapshotEqual(left, right) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["q"])(left.query, right.query) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deepEqual"])(left.data(), right.data());
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class WriteBatch {
    /** @hideconstructor */ constructor(_firestore, _commitHandler){
        ...
        this._dataReader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(_firestore);
    }
    set(documentRef, data, options) {
        this._verifyNotCommitted();
        const ref = validateReference(documentRef, this._firestore);
        const convertedValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(ref.converter, data, options);
        const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["p"])(this._dataReader, 'WriteBatch.set', ref._key, convertedValue, ref.converter !== null, options);
        this._mutations.push(parsed.toMutation(ref._key, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["P"].none()));
        return this;
    }
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        ...
        fieldOrUpdateData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getModularInstance"])(fieldOrUpdateData);
        let parsed;
        if (typeof fieldOrUpdateData === 'string' || fieldOrUpdateData instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"]) {
            parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        } else {
            parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["k"])(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData);
        }
        this._mutations.push(parsed.toMutation(ref._key, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["P"].exists(true)));
        return this;
    }
    /**
 ...
 */ function writeBatch(firestore) {
    ...
    const datastore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"])(firestore);
    return new WriteBatch(firestore, (writes)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["o"])(datastore, writes));
}
/**
 * @license
 * Copyright 2022 Google LLC
 ...
 */ class Transaction$1 {
    ...
    async lookup(keys) {
        ...
        if (this.mutations.length > 0) {
            this.lastTransactionError = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["C"].INVALID_ARGUMENT, 'Firestore transactions require all reads to be executed before all writes.');
            throw this.lastTransactionError;
        }
        const docs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["x"])(this.datastore, keys);
    ...
    delete(key) {
        this.write(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["D"](key, this.precondition(key)));
        this.writtenDocs.add(key.toString());
    }
    async commit() {
        this.ensureCommitNotCalled();
        ...
        unwritten.forEach((_, path)=>{
            const key = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["y"].fromPath(path);
            this.mutations.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["V"](key, this.precondition(key)));
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["o"])(this.datastore, this.mutations);
        this.committed = true;
    }
    recordVersion(doc) {
        let docVersion;
        if (doc.isFoundDocument()) {
            ...
            docVersion = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["S"].min();
        } else {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"])(0xc542, {
        ...
        if (existingVersion) {
            if (!docVersion.isEqual(existingVersion)) {
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["C"].ABORTED, 'Document version changed between two reads.');
            }
        } else {
     ...
     */ precondition(key) {
        ...
        if (!this.writtenDocs.has(key.toString()) && version) {
            if (version.isEqual(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["S"].min())) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["P"].exists(false);
            } else {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["P"].updateTime(version);
            }
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["P"].none();
        }
    }
    /**
     ...
     */ preconditionForUpdate(key) {
        ...
        if (!this.writtenDocs.has(key.toString()) && version) {
            if (version.isEqual(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["S"].min())) {
                ...
                // transaction.
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["C"].INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
            }
            ...
            // update.
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["P"].exists(true);
        }
    }
    write(mutation) {
        this.ensureCommitNotCalled();
 ...
 */ class TransactionRunner {
    ...
    tryRunUpdateFunction(transaction) {
        try {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(userPromise) || !userPromise.catch || !userPromise.then) {
    ...
    isRetryableTransactionError(error) {
        if (error?.name === 'FirebaseError') {
            ...
            return code === 'aborted' || code === 'failed-precondition' || code === 'already-exists' || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(code);
        }
        return false;
    }
}
 ...
 */ class DelayedOperation {
     ...
     */ cancel(reason) {
        if (this.timerHandle !== null) {
            this.clearTimeout();
            this.deferred.reject(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["C"].CANCELLED, 'Operation cancelled' + (reason ? ': ' + reason : '')));
        }
    }
    handleDelayElapsed() {
        this.asyncQueue.enqueueAndForget(()=>{
...
class AsyncQueueImpl {
     ...
     */ async retryNextOp() {
        ...
        try {
            ...
            if (isIndexedDbTransactionError(e)) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(LOG_TAG, 'Operation failed with retryable error: ' + e);
            } else {
    ...
    enqueueInternal(op) {
        const newTail = this.tail.then(()=>{
            ...
            return op().catch((error)=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"])('INTERNAL UNHANDLED ERROR: ', message);
    ...
    verifyNotFailed() {
        if (this.failure) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"])(0xb815, {
 ...
 */ class Transaction {
     ...
     */ get(documentRef) {
        const ref = validateReference(documentRef, this._firestore);
        const userDataWriter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"](this._firestore);
        return this._transaction.lookup([
            ref._key
        ]).then((docs)=>{
            if (!docs || docs.length !== 1) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"])(0x5de9);
            }
            const doc = docs[0];
            if (doc.isFoundDocument()) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["t"](this._firestore, userDataWriter, doc.key, doc, ref.converter);
            } else if (doc.isNoDocument()) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["t"](this._firestore, userDataWriter, ref._key, null, ref.converter);
            } else {
                throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"])(0x4801, {
                    doc
                });
            }
        });
    ...
    set(documentRef, value, options) {
        const ref = validateReference(documentRef, this._firestore);
        const convertedValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(ref.converter, value, options);
        const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["p"])(this._dataReader, 'Transaction.set', ref._key, convertedValue, ref.converter !== null, options);
    ...
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        ...
        let parsed;
        if (typeof fieldOrUpdateData === 'string' || fieldOrUpdateData instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"]) {
            parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        } else {
            parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["k"])(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData);
        }
...
__turbopack_context__.s([
    "AggregateField",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AggregateField"],
    "AggregateQuerySnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AggregateQuerySnapshot"],
    "Bytes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["B"],
    "CollectionReference",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["A"],
    "DocumentReference",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["E"],
    "DocumentSnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["t"],
    "FieldPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"],
    "FieldValue",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["G"],
    "Firestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["F"],
    "FirestoreError",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"],
    "GeoPoint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["H"],
    "Query",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Q"],
    "QueryCompositeFilterConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["I"],
    "QueryConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["J"],
    "QueryDocumentSnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["K"],
    "QueryEndAtConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["M"],
    "QueryFieldFilterConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["N"],
    "QueryLimitConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["R"],
    "QueryOrderByConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["T"],
    "QuerySnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["U"],
    "QueryStartAtConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["W"],
    "Timestamp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["X"],
    "Transaction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Transaction"],
    "VectorValue",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Y"],
    "WriteBatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["WriteBatch"],
    "addDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Z"],
    "aggregateFieldEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["aggregateFieldEqual"],
    "aggregateQuerySnapshotEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["aggregateQuerySnapshotEqual"],
    "and",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_"],
    "arrayRemove",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["$"],
    "arrayUnion",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a0"],
    "average",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["average"],
    "collection",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a1"],
    "collectionGroup",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a2"],
    "connectFirestoreEmulator",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a3"],
    "count",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["count"],
    "deleteDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a4"],
    "deleteField",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a5"],
    "doc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a6"],
    "documentId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a7"],
    "endAt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a8"],
    "endBefore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a9"],
    "getAggregate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAggregate"],
    "getCount",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getCount"],
    "getDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aa"],
    "getDocs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ab"],
    "getFirestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ac"],
    "increment",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ad"],
    "initializeFirestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ae"],
    "limit",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["af"],
    "limitToLast",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ag"],
    "or",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ah"],
    "orderBy",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ai"],
    "query",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aj"],
    "queryEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["q"],
    "refEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ak"],
    "runTransaction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["runTransaction"],
    "serverTimestamp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["al"],
    "setDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["am"],
    "setLogLevel",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["an"],
    "snapshotEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ao"],
    "startAfter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ap"],
    "startAt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aq"],
    "sum",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sum"],
    "terminate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ar"],
    "updateDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["as"],
    "vector",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["at"],
    "where",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["au"],
    "writeBatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["writeBatch"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/lite/index.node.mjs [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$df61403f$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/lite/common-df61403f.node.mjs [app-ssr] (ecmascript)");
}),
];

//# sourceMappingURL=node_modules_%40firebase_firestore_dist_lite_9a84a92c._.js.map