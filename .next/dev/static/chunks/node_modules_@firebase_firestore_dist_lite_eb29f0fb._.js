...
"[project]/node_modules/@firebase/firestore/dist/lite/common-a3b291a4.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "a",
    ()=>__PRIVATE_LiteAuthCredentialsProvider,
    "a0",
    ()=>arrayUnion,
    "a1",
    ()=>collection,
    ...
    ()=>UserDataReader,
    "aE",
    ()=>__PRIVATE_invokeExecutePipeline,
    "aF",
    ...
    "b",
    ()=>__PRIVATE_LiteAppCheckTokenProvider,
    "c",
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const m = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"]("@firebase/firestore");
/**
...
function __PRIVATE_logDebug(e, ...t) {
    if (m.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].DEBUG) {
        const r = t.map(__PRIVATE_argToString);
        m.debug(`Firestore (${d}): ${e}`, ...r);
    }
}
function __PRIVATE_logError(e, ...t) {
    if (m.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].ERROR) {
        const r = t.map(__PRIVATE_argToString);
 ...
 */ function __PRIVATE_logWarn(e, ...t) {
    if (m.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].WARN) {
        const r = t.map(__PRIVATE_argToString);
 ...
 */ class __PRIVATE_FirstPartyToken {
    constructor(e, t, r){
        this.i = e, this.o = t, this.u = r, this.type = "FirstParty", this.user = User.FIRST_PARTY, this.l = new Map;
    }
    /**
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, t){
        this.m = t, this.appCheck = null, this.P = null, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_isFirebaseServerApp"])(e) && e.settings.appCheckToken && (this.P = e.settings.appCheckToken), t.onInit((e)=>{
            this.appCheck = e;
        });
    }
    getToken() {
...
function __PRIVATE_databaseIdFromApp(e, t) {
    if (!Object.prototype.hasOwnProperty.apply(e.options, [
        "projectId"
    ])) throw new FirestoreError(E.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */ class __PRIVATE_RestConnection {
    ...
    I(e, r, n, i, s) {
        ...
        this.F(u, i, s);
        const { host: _ } = new URL(a), c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCloudWorkstation"])(_);
...
/** Extracts the backend's type order for the provided value. */ function __PRIVATE_typeOrder(e) {
    ...
    }(e) ? 9007199254740991 /* TypeOrder.MaxValue */  : /** Returns true if `value` is a VetorValue. */ function __PRIVATE_isVectorValue(e) {
        const t = (e?.mapValue?.fields || {})[D]?.stringValue;
        return t === N;
    }(e) ? 10 /* TypeOrder.VectorValue */  : 11 /* TypeOrder.ObjectValue */  : fail(28295, {
        value: e
    });
}
...
class SortedMapIterator {
    constructor(e, t, r, n){
        ...
        t && n && (i *= -1), i < 0) // This node is less than our start key. ignore it
 ...
 */ class MutableDocument {
     ...
     */ static newFoundDocument(e, t, r, n) {
        return new MutableDocument(e, 1 /* DocumentType.FOUND_DOCUMENT */ , /* version */ t, /* readTime */ SnapshotVersion.min(), /* createTime */ r, n, 0 /* DocumentState.SYNCED */ );
    }
 ...
 */ function __PRIVATE_queryNormalizedOrderBy(e) {
    ...
    if (null === t.q) {
        ...
        const r = t.explicitOrderBy.length > 0 ? t.explicitOrderBy[t.explicitOrderBy.length - 1].dir : "asc" /* Direction.ASCENDING */ , n = // Returns the sorted set of inequality filter fields used in this query.
 ...
 */ class __PRIVATE_SetMutation extends Mutation {
    constructor(e, t, r, n = []){
        super(), this.key = e, this.value = t, this.precondition = r, this.fieldTransforms = n, this.type = 0 /* MutationType.Set */ ;
    }
    getFieldMask() {
        return null;
    }
 ...
 */ class __PRIVATE_PatchMutation extends Mutation {
    constructor(e, t, r, n, i = []){
        super(), this.key = e, this.data = t, this.fieldMask = r, this.precondition = n, this.fieldTransforms = i, this.type = 1 /* MutationType.Patch */ ;
    }
    getFieldMask() {
...
function __PRIVATE_fromPipelineResponse(e, t, r) {
    ...
    return n.executionTime = i, r && (n.key = r.name ? fromName(e, r.name) : void 0, n.fields = new ObjectValue({
        mapValue: {
            fields: r.fields
        }
    }), n.createTime = r.createTime ? __PRIVATE_fromVersion(r.createTime) : void 0, n.updateTime = r.updateTime ? __PRIVATE_fromVersion(r.updateTime) : void 0), n;
}
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */ I(e, t, r, n) {
        return this.j(), Promise.all([
            this.authCredentials.getToken(),
            this.appCheckCredentials.getToken()
        ]).then(([i, s])=>this.connection.I(e, __PRIVATE_toResourcePath(t, r), n, i, s)).catch((e)=>{
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ D(e, t, r, n, i) {
        return this.j(), Promise.all([
            this.authCredentials.getToken(),
            this.appCheckCredentials.getToken()
        ]).then(([s, o])=>this.connection.D(e, __PRIVATE_toResourcePath(t, r), n, s, o, i)).catch((e)=>{
            throw "FirebaseError" === e.name ? (e.code === E.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e) : new FirestoreError(E.UNKNOWN, e.toString());
        });
    }
    terminate() {
...
async function __PRIVATE_invokeRunQueryRpc(e, t) {
    ...
    return (await r.D("RunQuery", r.serializer.databaseId, i, {
        structuredQuery: n.structuredQuery
            ...
            return r && a.setHasCommittedMutations(), ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : a;
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, r) {
    const n = __PRIVATE_debugCast(e), { request: i, K: s, parent: o } = function __PRIVATE_toRunAggregationQueryRequest(e, t, r, n) {
        ...
        const t = __PRIVATE_debugCast(e);
        return t.B || (// Do not include implicit order-bys for aggregate queries.
        t.B = __PRIVATE__queryToTarget(t, e.explicitOrderBy)), t.B;
    }(t), r);
    n.connection.T || delete i.parent;
    const a = (await n.D("RunAggregationQuery", n.serializer.databaseId, o, i, /*expectedResponseCount=*/ 1)).filter((e)=>!!e.result);
...
class Firestore {
    /** @hideconstructor */ constructor(e, t, r, n){
...
function initializeFirestore(e, t, r) {
    r || (r = P);
    const n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(e, "firestore/lite");
...
function getFirestore(e, t) {
    const n = "object" == typeof e ? e : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])(), i = "string" == typeof e ? e : t || "(default)", s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(n, "firestore/lite").getImmediate({
        identifier: i
    });
    if (!s._initialized) {
 ...
 */ function connectFirestoreEmulator(e, r, a, u = {}) {
    ...
    const _ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCloudWorkstation"])(r), c = e._getSettings(), l = {
        ...c,
        emulatorOptions: e._getEmulatorOptions()
    }, h = `${r}:${a}`;
    _ && ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pingServer"])(`https://${h}`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateEmulatorBanner"])("Firestore", !0)), c.host !== M && c.host !== h && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    const f = {
        ...c,
        host: h,
        ssl: _,
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(f, l) && (e._setSettings(f), u.mockUserToken)) {
        let t, r;
        if ("string" == typeof u.mockUserToken) t = u.mockUserToken, r = User.MOCK_USER;
        else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMockUserToken"])(u.mockUserToken, e._app?.options.projectId);
 ...
 */ function terminate(e) {
    return e = __PRIVATE_cast(e, Firestore), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_removeServiceInstance"])(e.app, "firestore/lite"), e._delete();
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class CollectionReference extends Query {
    /** @hideconstructor */ constructor(e, t, r){
...
function collection(e, t, ...r) {
    if (e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e), __PRIVATE_validateNonEmptyArgument("collection", "path", t), e instanceof Firestore) {
    ...
    }
    {
        ...
        return __PRIVATE_validateCollectionPath(n), new CollectionReference(e.firestore, /* converter= */ null, n);
    }
}
...
function doc(e, t, ...r) {
    ...
    1 === arguments.length && (t = __PRIVATE_AutoId.newId()), __PRIVATE_validateNonEmptyArgument("doc", "path", t), e instanceof Firestore) {
        const n = ResourcePath.fromString(t, ...r);
        return __PRIVATE_validateDocumentPath(n), new DocumentReference(e, /* converter= */ null, new DocumentKey(n));
    }
    {
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(e) {
        const t = __PRIVATE_createSentinelChildContext(this, e, /*array=*/ !0), r = this.G.map((e)=>__PRIVATE_parseData(e, t)), n = new __PRIVATE_ArrayUnionTransformOperation(r);
        return new FieldTransform(e.path, n);
    }
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayUnionFieldValueImpl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this.G, e.G);
    }
}
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(e) {
        const t = __PRIVATE_createSentinelChildContext(this, e, /*array=*/ !0), r = this.G.map((e)=>__PRIVATE_parseData(e, t)), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
        return new FieldTransform(e.path, n);
    }
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayRemoveFieldValueImpl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this.G, e.G);
    }
}
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, r, n, i, s) {
    const o = e.createContext(1 /* UserDataSource.Update */ , t, r), u = [
        __PRIVATE_fieldPathFromArgument(t, n, r)
    ], _ = [
        i
    ];
 ...
 */ function __PRIVATE_fieldPathFromArgument(e, t, r) {
    ...
    throw createError("Field path arguments must be of type string or ", e, /* hasConverter= */ !1, /* path= */ void 0, r);
}
/**
 ...
 */ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, r) {
    if (t.search(j) >= 0) throw createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, /* hasConverter= */ !1, /* path= */ void 0, r);
    try {
        return new FieldPath(...t.split("."))._internalPath;
    } catch (n) {
        throw createError(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, e, /* hasConverter= */ !1, /* path= */ void 0, r);
    }
}
 ...
 */ class DocumentSnapshot {
    ...
    /** @hideconstructor protected */ constructor(e, t, r, n, i){
     ...
     */ data() {
        if (this._document) {
            if (this._converter) {
                ...
                const e = new QueryDocumentSnapshot(this._firestore, this._userDataWriter, this._key, this._document, /* converter= */ null);
 ...
 */ class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _parse(e) {
        const t = __PRIVATE_newUserDataReader(e.firestore), r = function __PRIVATE_newQueryFilter(e, t, r, n, i, s, o) {
            ...
            } else "in" /* Operator.IN */  !== s && "not-in" /* Operator.NOT_IN */  !== s && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */  !== s || __PRIVATE_validateDisjunctiveFilterElements(o, s), a = __PRIVATE_parseQueryValue(r, t, o, /* allowArrays= */ "in" /* Operator.IN */  === s || "not-in" /* Operator.NOT_IN */  === s);
 ...
 */ class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(e) {
        ...
        return new Query(e.firestore, e.converter, function __PRIVATE_queryWithAddedOrderBy(e, t) {
            ...
            const r = e.explicitOrderBy.concat([
                t
            ]);
 ...
 */ class QueryLimitConstraint extends QueryConstraint {
    /**
     * @internal
     */ constructor(/** The type of this query constraint */ e, t, r){
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(e, t, r, n) {
    if (r[0] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(e, t, r, n, i) {
...
function __PRIVATE_parseDocumentIdValue(e, t, r) {
    if ("string" == typeof (r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(r))) {
 ...
 */ function getDoc(e) {
    ...
    return __PRIVATE_invokeBatchGetDocumentsRpc(t, [
        e._key
    ]).then((t)=>{
 ...
 */ function getDocs(e) {
    ...
    return __PRIVATE_invokeRunQueryRpc(t, e._query).then((t)=>{
        ...
        return "L" /* LimitType.Last */  === e._query.limitType && // Limit to last queries reverse the orderBy constraint that was
...
function setDoc(e, t, r) {
    ...
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore(e.firestore), [
        i.toMutation(e._key, Precondition.none())
    ]);
}
function updateDoc(e, t, r, ...n) {
    ...
    // performing validation.
    let s;
    s = "string" == typeof (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t)) || t instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", e._key, t, r, n) : __PRIVATE_parseUpdateData(i, "updateDoc", e._key, t);
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore(e.firestore), [
        s.toMutation(e._key, Precondition.exists(!0))
    ]);
}
/**
 ...
 */ function deleteDoc(e) {
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore((e = __PRIVATE_cast(e, DocumentReference)).firestore), [
...
"[project]/node_modules/@firebase/firestore/dist/lite/index.browser.esm.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/lite/common-a3b291a4.esm.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/util/dist/index.esm.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/logger/dist/esm/index.esm.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$webchannel$2d$wrapper$2f$dist$2f$bloom$2d$blob$2f$esm$2f$bloom_blob_es2018$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/webchannel-wrapper/dist/bloom-blob/esm/bloom_blob_es2018.js [app-client] (ecmascript)");
;
 ...
 */ class __PRIVATE_ExponentialBackoff {
     ...
     */ s = 1e3, i = 1.5, r = 6e4){
        this.t = t, this.timerId = e, this.i = s, this.o = i, this.h = r, this.u = 0, this.l = null, /** The last backoff attempt, as epoch milliseconds. */ this._ = Date.now(), this.reset();
    }
    /**
     ...
     */ A(t) {
        ...
        i > 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"])("ExponentialBackoff", `Backing off for ${i} ms (base delay: ${this.u} ms, delay with jitter: ${e} ms, last attempt: ${s} ms ago)`), this.l = this.t.enqueueAfterDelay(this.timerId, i, ()=>(this._ = Date.now(), t())), // Apply backoff factor to determine next delay and ensure it is within
        // bounds.
 ...
 */ class AggregateQuerySnapshot {
    /** @hideconstructor */ constructor(t, e, s){
        this._userDataWriter = e, this._data = s, /** A type string to uniquely identify instances of this class. */ this.type = "AggregateQuerySnapshot", this.query = t;
    }
    /**
     ...
     */ _fieldsProto() {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["O"]({
            mapValue: {
                fields: this._data
            }
 ...
 */ function getAggregate(t, e) {
    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])(t.firestore, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]), i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])(s), r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"])(e, (t, e)=>new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath));
    // Run the aggregation and convert the results
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(i, t._query, r).then((e)=>(function __PRIVATE_convertToAggregateQuerySnapshot(t, e, s) {
            const i = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"](t), r = new AggregateQuerySnapshot(e, i, s);
            return r;
        })(s, t, e));
}
function sum(t) {
    return new AggregateField("sum", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])("sum", t));
}
/**
 ...
 */ function average(t) {
    return new AggregateField("avg", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])("average", t));
}
/**
 ...
 */ function aggregateQuerySnapshotEqual(t, e) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"])(t.query, e.query) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(t.data(), e.data());
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class WriteBatch {
    /** @hideconstructor */ constructor(t, e){
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, this._dataReader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"])(t);
    }
    set(t, e, s) {
        this._verifyNotCommitted();
        const i = __PRIVATE_validateReference(t, this._firestore), r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["k"])(i.converter, e, s), a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"])(this._dataReader, "WriteBatch.set", i._key, r, null !== i.converter, s);
        return this._mutations.push(a.toMutation(i._key, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].none())), this;
    }
    update(t, e, s, ...i) {
        this._verifyNotCommitted();
        ...
        // performing validation.
        let a;
        return a = "string" == typeof (e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e)) || e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"])(this._dataReader, "WriteBatch.update", r._key, e, s, i) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"])(this._dataReader, "WriteBatch.update", r._key, e), this._mutations.push(a.toMutation(r._key, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].exists(!0))), this;
    }
    /**
     ...
     */ delete(t) {
        ...
        return this._mutations = this._mutations.concat(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"](e._key, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].none())), this;
    }
    /**
 ...
 */ function writeBatch(t) {
    t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])(t, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]);
    const e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])(t);
    return new WriteBatch(t, (t)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(e, t));
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ class Transaction$1 {
    ...
    async lookup(t) {
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E"].INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
        const e = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["y"])(this.datastore, t);
    ...
    delete(t) {
        this.write(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"](t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
        ...
        // a `verify` operation.
        t.forEach((t, e)=>{
            const s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].fromPath(e);
            this.mutations.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["A"](s, this.precondition(s)));
        }), await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(this.datastore, this.mutations), this.committed = !0;
    }
    recordVersion(t) {
        let e;
        if (t.isFoundDocument()) e = t.version;
        else {
            if (!t.isNoDocument()) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(50498, {
                R: t.constructor.name
            });
            // Represent a deleted doc using SnapshotVersion.min().
            e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["S"].min();
        }
        const s = this.readVersions.get(t.key.toString());
        if (s) {
            if (!e.isEqual(s)) // This transaction will fail no matter what.
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E"].ABORTED, "Document version changed between two reads.");
     ...
     */ precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["S"].min()) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].exists(!1) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].updateTime(e) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].none();
    }
    /**
     ...
     */ preconditionForUpdate(t) {
        ...
        if (!this.writtenDocs.has(t.toString()) && e) {
            if (e.isEqual(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["S"].min())) // The document doesn't exist, so fail the transaction.
            ...
            // transaction.
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E"].INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
            // Document exists, base precondition on document update time.
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].updateTime(e);
        }
        // Document was not read, so we just use the preconditions for a blind
        // update.
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"].exists(!0);
    }
    write(t) {
 ...
 */ class __PRIVATE_TransactionRunner {
    constructor(t, e, s, i, r){
        this.asyncQueue = t, this.datastore = e, this.options = s, this.updateFunction = i, this.deferred = r, this.I = s.maxAttempts, this.P = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */ );
    }
    ...
    F(t) {
        try {
            ...
            return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"])(e) && e.catch && e.then ? e : (this.deferred.reject(Error("Transaction callback must return a Promise")), null);
        } catch (t) {
    ...
    B(t) {
        if ("FirebaseError" === t?.name) {
            ...
            const e = t.code;
            return "aborted" === e || "failed-precondition" === e || "already-exists" === e || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"])(e);
        }
        return !1;
    }
}
 ...
 */ class DelayedOperation {
    constructor(t, e, s, i, r){
        this.asyncQueue = t, this.timerId = e, this.targetTimeMs = s, this.op = i, this.removalCallback = r, this.deferred = new __PRIVATE_Deferred, this.then = this.deferred.promise.then.bind(this.deferred.promise), // It's normal for the deferred promise to be canceled (due to cancellation)
     ...
     */ cancel(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E"].CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    handleDelayElapsed() {
...
class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()){
        ...
        // be changed again.
        this.q = !1, // Operations scheduled to be queued in the future. Operations are
        // automatically removed after they are run or canceled.
        this.O = [], // visible for testing
        this.S = null, // Flag set while there's an outstanding AsyncQueue operation, used for
        // assertion sanity-checks.
        this.C = !1, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
        this.M = !1, // List of TimerIds to fast-forward delays for.
        this.N = [], // Backoff timer used to schedule retries for retryable operations
        this.P = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */ ), // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.L = ()=>{
            const t = getDocument();
            t && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"])(dt, "Visibility state changed to " + t.visibilityState), this.P.T();
        }, this.W = t;
        const e = getDocument();
    ...
    enqueue(t) {
        if (this.U(), this.q) // Return a Promise which never resolves.
        return new Promise(()=>{});
     ...
     */ async j() {
        if (0 !== this.k.length) {
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"])(dt, "Operation failed with retryable error: " + t);
            }
    ...
    $(t) {
        const e = this.W.then(()=>(this.C = !0, t().catch((t)=>{
                ...
                throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["x"])("INTERNAL UNHANDLED ERROR: ", e), t;
            }).then((t)=>(this.C = !1, t))));
        return this.W = e, e;
    }
    ...
    U() {
        this.S && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(47125, {
     ...
     */ X(t) {
        ...
        return this.J().then(()=>{
            ...
            /* eslint-disable-next-line @typescript-eslint/no-floating-promises */ this.O.sort((t, e)=>t.targetTimeMs - e.targetTimeMs);
 ...
 */ class Transaction {
    /** @hideconstructor */ constructor(t, e){
        this._firestore = t, this._transaction = e, this._dataReader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"])(t);
    }
    /**
     ...
     */ get(t) {
        const e = __PRIVATE_validateReference(t, this._firestore), s = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"](this._firestore);
        return this._transaction.lookup([
            e._key
        ]).then((t)=>{
            if (!t || 1 !== t.length) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(24041);
            const i = t[0];
            if (i.isFoundDocument()) return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["D"](this._firestore, s, i.key, i, e.converter);
            if (i.isNoDocument()) return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["D"](this._firestore, s, e._key, null, e.converter);
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(18433, {
                doc: i
            });
        });
    }
    set(t, e, s) {
        const i = __PRIVATE_validateReference(t, this._firestore), r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["k"])(i.converter, e, s), a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"])(this._dataReader, "Transaction.set", i._key, r, null !== i.converter, s);
    ...
    update(t, e, s, ...i) {
        ...
        // performing validation.
        let a;
        return a = "string" == typeof (e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e)) || e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"])(this._dataReader, "Transaction.update", r._key, e, s, i) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"])(this._dataReader, "Transaction.update", r._key, e), this._transaction.update(r._key, a), this;
    }
    /**
     * Deletes the document referred to by the provided {@link DocumentReference}.
     *
 ...
 */ function runTransaction(t, e, s) {
    t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])(t, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]);
    const i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])(t), r = {
        ...ft,
        ...s
    };
    !function __PRIVATE_validateTransactionOptions(t) {
        if (t.maxAttempts < 1) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E"].INVALID_ARGUMENT, "Max attempts must be at least 1");
    }(r);
 ...
 */ !function __PRIVATE_registerFirestore() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["SDK_VERSION"]}_lite`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_registerComponent"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$component$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"]("firestore/lite", (t, { instanceIdentifier: e, options: s })=>{
        const i = t.getProvider("app").getImmediate(), r = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"](t.getProvider("auth-internal")), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"](i, t.getProvider("app-check-internal")), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(i, e), i);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["registerVersion"])("firestore-lite", _t, ""), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["registerVersion"])("firestore-lite", _t, "esm2020");
}();
;
 //# sourceMappingURL=index.browser.esm.js.map
}),
"[project]/node_modules/@firebase/firestore/dist/lite/index.browser.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "AggregateField",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AggregateField"],
    "AggregateQuerySnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AggregateQuerySnapshot"],
    "Bytes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"],
    "CollectionReference",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"],
    "DocumentReference",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["G"],
    "DocumentSnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["D"],
    "FieldPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"],
    "FieldValue",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["H"],
    "Firestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"],
    "FirestoreError",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"],
    "GeoPoint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["I"],
    "Query",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Q"],
    "QueryCompositeFilterConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["J"],
    "QueryConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["K"],
    "QueryDocumentSnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L"],
    "QueryEndAtConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["M"],
    "QueryFieldFilterConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"],
    "QueryLimitConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"],
    "QueryOrderByConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"],
    "QuerySnapshot",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"],
    "QueryStartAtConstraint",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["V"],
    "Timestamp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["W"],
    "Transaction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Transaction"],
    "VectorValue",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["X"],
    "WriteBatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["WriteBatch"],
    "addDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Y"],
    "aggregateFieldEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["aggregateFieldEqual"],
    "aggregateQuerySnapshotEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["aggregateQuerySnapshotEqual"],
    "and",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Z"],
    "arrayRemove",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"],
    "arrayUnion",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a0"],
    "average",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["average"],
    "collection",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a1"],
    "collectionGroup",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a2"],
    "connectFirestoreEmulator",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a3"],
    "count",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["count"],
    "deleteDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a4"],
    "deleteField",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a5"],
    "doc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a6"],
    "documentId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a7"],
    "endAt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a8"],
    "endBefore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a9"],
    "getAggregate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAggregate"],
    "getCount",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getCount"],
    "getDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"],
    "getDocs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ab"],
    "getFirestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ac"],
    "increment",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ad"],
    "initializeFirestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ae"],
    "limit",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["af"],
    "limitToLast",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ag"],
    "or",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ah"],
    "orderBy",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ai"],
    "query",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aj"],
    "queryEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"],
    "refEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ak"],
    "runTransaction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["runTransaction"],
    "serverTimestamp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["al"],
    "setDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["am"],
    "setLogLevel",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["an"],
    "snapshotEqual",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ao"],
    "startAfter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ap"],
    "startAt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aq"],
    "sum",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sum"],
    "terminate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ar"],
    "updateDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["as"],
    "vector",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["at"],
    "where",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["au"],
    "writeBatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["writeBatch"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/lite/index.browser.esm.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$lite$2f$common$2d$a3b291a4$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/lite/common-a3b291a4.esm.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=node_modules_%40firebase_firestore_dist_lite_eb29f0fb._.js.map